...
class LoginState extends State<Login> {
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
        child: Container(
            padding: const EdgeInsets.symmetric(vertical: 51, horizontal: 16),
            child: mediaQuery.size.width >= 600
                ...
                : Column(mainAxisSize: MainAxisSize.min, children: [
                    ...
                    LoginField(controller: email, placeholder: 'Email'),
                    const SizedBox(height: 6),
                    LoginField(controller: password, placeholder: 'Password'),
                    const SizedBox(height: 40),
                    Row(
                      children: const [
                        ...
                        SizedBox(width: 20),
                        Expanded(child: TwitterButton(compact: true)),
                      ],
                    ),
                    const SizedBox(height: 40),
                    GestureDetector(
